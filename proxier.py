...
class Proxy(object):
    proxy_url = u'http://www.ip-adress.com/proxy_list/'
    proxy_list = []
    ...
    def __init__(self):
        ...
        proxies_tag = soup.find_all(u'tr', class_=u'odd')

        for proxy_tag in proxies_tag:
            self.proxy_list.append(proxy_tag.find_all(u'td')[0].text.strip())
